...
46:                                               ; preds = %27
  %47 = bitcast i32* %2 to i8*, !dbg !226
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %47), !dbg !226
  call void @llvm.dbg.value(metadata i32 %7, metadata !138, metadata !DIExpression()) #3, !dbg !226
  store i32 %7, i32* %2, align 4, !tbaa !180
  call void @llvm.dbg.value(metadata i32 1, metadata !139, metadata !DIExpression()) #3, !dbg !226
  call void @llvm.dbg.value(metadata i32* %2, metadata !138, metadata !DIExpression(DW_OP_deref)) #3, !dbg !226
  %48 = call i8* inttoptr (i64 1 to i8* (i8*, i8*)*)(i8* bitcast ({ [12 x i32]*, [8 x i32]*, i32*, [8 x %struct.inner_map_queue*] }* @outer_map_queue to i8*), i8* nonnull %47) #3, !dbg !229
  call void @llvm.dbg.value(metadata i8* %48, metadata !140, metadata !DIExpression()) #3, !dbg !226
  %49 = icmp eq i8* %48, null, !dbg !230
  br i1 %49, label %54, label %50, !dbg !231

50:                                               ; preds = %46
  call void @llvm.dbg.value(metadata i32 1, metadata !139, metadata !DIExpression()) #3, !dbg !226
  %51 = bitcast i32* %3 to i8*, !dbg !232
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %51) #3, !dbg !233
  call void @llvm.dbg.value(metadata i32 1, metadata !141, metadata !DIExpression()) #3, !dbg !232
  store i32 1, i32* %3, align 4, !dbg !234, !tbaa !180
  call void @llvm.dbg.value(metadata i32* %3, metadata !141, metadata !DIExpression(DW_OP_deref)) #3, !dbg !232
  %52 = call i64 inttoptr (i64 87 to i64 (i8*, i8*, i64)*)(i8* nonnull %48, i8* nonnull %51, i64 2) #3, !dbg !235
  %53 = icmp slt i64 %52, 0, !dbg !236
  br i1 %53, label %56, label %58, !dbg !237

54:                                               ; preds = %46
  %55 = call i64 (i8*, i32, ...) inttoptr (i64 6 to i64 (i8*, i32, ...)*)(i8* getelementptr inbounds ([35 x i8], [35 x i8]* @lookup_map_of_maps_queue.____fmt, i64 0, i64 0), i32 35) #3, !dbg !238
  br label %61, !dbg !239

56:                                               ; preds = %79, %76, %73, %58, %50
  %57 = call i64 (i8*, i32, ...) inttoptr (i64 6 to i64 (i8*, i32, ...)*)(i8* getelementptr inbounds ([38 x i8], [38 x i8]* @lookup_map_of_maps_queue.____fmt.1, i64 0, i64 0), i32 38) #3, !dbg !240
  call void @llvm.dbg.value(metadata i32 3, metadata !139, metadata !DIExpression()) #3, !dbg !226
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %51) #3, !dbg !241
  br label %61
...
58:                                               ; preds = %50
  ...
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %51) #3, !dbg !241
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %51) #3, !dbg !233
  call void @llvm.dbg.value(metadata i32 3, metadata !141, metadata !DIExpression()) #3, !dbg !232
  store i32 3, i32* %3, align 4, !dbg !234, !tbaa !180
  call void @llvm.dbg.value(metadata i32* %3, metadata !141, metadata !DIExpression(DW_OP_deref)) #3, !dbg !232
  %59 = call i64 inttoptr (i64 87 to i64 (i8*, i8*, i64)*)(i8* nonnull %48, i8* nonnull %51, i64 2) #3, !dbg !235
  %60 = icmp slt i64 %59, 0, !dbg !236
  br i1 %60, label %56, label %73, !dbg !237
...
73:                                               ; preds = %58
  call void @llvm.dbg.value(metadata i32 5, metadata !139, metadata !DIExpression()) #3, !dbg !226
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %51) #3, !dbg !241
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %51) #3, !dbg !233
  call void @llvm.dbg.value(metadata i32 5, metadata !141, metadata !DIExpression()) #3, !dbg !232
  store i32 5, i32* %3, align 4, !dbg !234, !tbaa !180
  call void @llvm.dbg.value(metadata i32* %3, metadata !141, metadata !DIExpression(DW_OP_deref)) #3, !dbg !232
  %74 = call i64 inttoptr (i64 87 to i64 (i8*, i8*, i64)*)(i8* nonnull %48, i8* nonnull %51, i64 2) #3, !dbg !235
  %75 = icmp slt i64 %74, 0, !dbg !236
  br i1 %75, label %56, label %76, !dbg !237

76:                                               ; preds = %73
  call void @llvm.dbg.value(metadata i32 7, metadata !139, metadata !DIExpression()) #3, !dbg !226
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %51) #3, !dbg !241
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %51) #3, !dbg !233
  call void @llvm.dbg.value(metadata i32 7, metadata !141, metadata !DIExpression()) #3, !dbg !232
  store i32 7, i32* %3, align 4, !dbg !234, !tbaa !180
  call void @llvm.dbg.value(metadata i32* %3, metadata !141, metadata !DIExpression(DW_OP_deref)) #3, !dbg !232
  %77 = call i64 inttoptr (i64 87 to i64 (i8*, i8*, i64)*)(i8* nonnull %48, i8* nonnull %51, i64 2) #3, !dbg !235
  %78 = icmp slt i64 %77, 0, !dbg !236
  br i1 %78, label %56, label %79, !dbg !237

79:                                               ; preds = %76
  call void @llvm.dbg.value(metadata i32 9, metadata !139, metadata !DIExpression()) #3, !dbg !226
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %51) #3, !dbg !241
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %51) #3, !dbg !233
  call void @llvm.dbg.value(metadata i32 9, metadata !141, metadata !DIExpression()) #3, !dbg !232
  store i32 9, i32* %3, align 4, !dbg !234, !tbaa !180
  call void @llvm.dbg.value(metadata i32* %3, metadata !141, metadata !DIExpression(DW_OP_deref)) #3, !dbg !232
  %80 = call i64 inttoptr (i64 87 to i64 (i8*, i8*, i64)*)(i8* nonnull %48, i8* nonnull %51, i64 2) #3, !dbg !235
  %81 = icmp slt i64 %80, 0, !dbg !236
  br i1 %81, label %56, label %82, !dbg !237

82:                                               ; preds = %79
  call void @llvm.dbg.value(metadata i32 11, metadata !139, metadata !DIExpression()) #3, !dbg !226
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %51) #3, !dbg !241
  br label %61
}
...
!3 = !DIFile(filename: "xdp_prog_kern.c", directory: "/home/pvvalenc/benchmark/benchmark_XDP_map/user_kernel_com/user_kernel")
!4 = !{!5}
...
!115 = !DIFile(filename: "../lib/install/include/bpf/bpf_helper_defs.h", directory: "/home/pvvalenc/benchmark/benchmark_XDP_map/user_kernel_com/user_kernel")
...
!159 = !{!"clang version 10.0.0-4ubuntu1 "}
...
!225 = !DILocation(line: 91, column: 9, scope: !205)
!226 = !DILocation(line: 0, scope: !134, inlinedAt: !227)
!227 = distinct !DILocation(line: 92, column: 13, scope: !228)
!228 = distinct !DILexicalBlock(scope: !199, file: !3, line: 91, column: 16)
!229 = !DILocation(line: 52, column: 35, scope: !134, inlinedAt: !227)
!230 = !DILocation(line: 54, column: 9, scope: !208, inlinedAt: !227)
!231 = !DILocation(line: 54, column: 8, scope: !134, inlinedAt: !227)
!232 = !DILocation(line: 0, scope: !142, inlinedAt: !227)
!233 = !DILocation(line: 60, column: 9, scope: !142, inlinedAt: !227)
!234 = !DILocation(line: 60, column: 13, scope: !142, inlinedAt: !227)
!235 = !DILocation(line: 61, column: 12, scope: !214, inlinedAt: !227)
!236 = !DILocation(line: 61, column: 50, scope: !214, inlinedAt: !227)
!237 = !DILocation(line: 61, column: 12, scope: !142, inlinedAt: !227)
!238 = !DILocation(line: 55, column: 9, scope: !218, inlinedAt: !227)
!239 = !DILocation(line: 56, column: 9, scope: !219, inlinedAt: !227)
!240 = !DILocation(line: 62, column: 13, scope: !222, inlinedAt: !227)
!241 = !DILocation(line: 66, column: 5, scope: !134, inlinedAt: !227)
!242 = !DILocation(line: 96, column: 5, scope: !57)
